# Django settings for Degollado504 project.
import os
...
SECRET_KEY = '^l+!fgoxb*xdc8@(oci-sk(1)(e3o1db50a$!25evnopr4=+-k'
...
ROOT_URLCONF = 'Degollado504.urls'
APPEND_SLASH = False
...
WSGI_APPLICATION = 'Degollado504.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = (
    'Degollado504.migrations',
    'Degollado504.tests',
    'Degollado504.local_settings',
    'opal.migrations',
    'opal.tests',
    'opal.wsgi',
)
...
DEFAULT_DOMAIN = 'http://Degollado504.com/'


# ========== PROJECT ==========
OPAL_BRAND_NAME = 'Degollado504'
